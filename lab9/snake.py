...
snake_block = 10
initial_snake_speed = 15  # Initial snake speed
...
def generate_food():
    ...
    food_score = random.randint(1, 8)  # Random score between 1 and 8
...
def gameLoop():
    ...
    while not game_over:
        ...
        # Draw snake and update score and level
        ...
        if x1 == food_x and y1 == food_y:
            food_x, food_y, food_score = generate_food()  # Generate new food
            Length_of_snake += food_score
            if Length_of_snake % 5 == 0:  # Increase speed every 5 points
                snake_speed += 1
            if Length_of_snake % 10 == 0:  # Increase level every 10 points
                level += 1
